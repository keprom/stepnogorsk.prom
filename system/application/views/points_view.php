<div id="pagecontent">
    ...
    <ul class="tabset_tabs">
        ...
        foreach ($result->result() as $r):
            if (($fir == 2) && ($last_tp != $r->tp_id)) {
                echo "<li ><a class=\"\" href=\"#tp" . $r->tp_id . "\" >ТП-" . $r->tp_name . "</a></li>;<br />";
                $str += 1;
                $last_tp = $r->tp_id;
            }
            if (($fir == 1) && ($last_tp != $r->tp_id)) {
                echo "<li><a class=\"preActive\" href=\"#tp" . $r->tp_id . "\">ТП-" . $r->tp_name . "</a></li>;<br />";
                $fir = 2;
                $last_tp = $r->tp_id;
                $str += 1;
            }
            if (($fir == 0) && ($last_tp != $r->tp_id)) {
                echo "<li><a class=\"preActive postActive\" href=\"#tp" . $r->tp_id . "\">ТП-" . $r->tp_name . "</a></li>;<br />";
                $fir = 1;
                $last_tp = $r->tp_id;
                $str += 1;
            }
            if ($fir == -1) {
                echo "<li class=\"firstchild\"><a href=\"#tp" . $r->tp_id . "\" class=\"preActive active\">ТП-" . $r->tp_name . "</a></li>;<br />";
                $fir = 0;
                $last_tp = $r->tp_id;
                $str += 1;
            }
...
<font color=purpure>" . $r->crafted_year . "</font>"); ?></td>
        ...
        <table border=1 width=100% cellspacing=0>
            <tr>
                <td><b>Название точки учета</b></td>
                <td><b>ТП</b></td>
                <td><b>Адрес</b></td>
                <td><b>Операции</b></td>
            </tr>
...
<font color=purpure>" . $r->crafted_year . "</font>"); ?></td>
            ...
            if ($fir == -1){
            echo "<div id=\"tp" . $r->tp_id . "\" class=\"tabset_content tabset_content_active\"><h2 class=\"tabset_label\">ТП-" . $r->tp_name . "</h2><p>";
            ?>
            <table border=1 width=100% cellspacing=0>
                <tr>
                    <td><b>Название точки учета</b></td>
