...
<FONT size=7>
    <table width=100%>
        <tr align=center>
            <td width=1850px>
                <b><?php echo(strlen(trim($akt_vypolnenyh_rabot)) == 0 ? "1Есеп шот фактура / Счет-фактура" : $akt_vypolnenyh_rabot); ?>
                    №</b> <?php
                if (strlen($schet2) == 0) {
            ...
            <td width=300px> <?php echo $org->svidetelstvo_nds; ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
    ...
    <table border="1px" width="100%" align="center">
        ...
        foreach ($s as $s2):
            ...
            <tr align="center">
                ...
                <TD width="400px">Услуги по передаче и/или распределению электроэнергии за
                    <br/> <?php echo datetostring2($schetfactura_date->date); ?> года
                </td>
                ...
                <TD width="250px" align="right">
                    ...
                    if ($i_nds - $s2->nds_value >= 1) {
                        echo(f_d3($s2->nds_value));
                        $sum_nds += $s2->nds_value;
                        $i_nds -= f_d3($s2->nds_value);
                    } else
                        echo f_d3($i_nds);
                    ?>
                </td>
