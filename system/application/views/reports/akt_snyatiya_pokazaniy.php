...
<table width=50%>
    <tr>
        <td align=center><b>АКТ</b></td>
    </tr>
    <tr>
        <td align=center><b>снятия показаний приборов коммерческого учета и расчета</b></td>
    </tr>
...
?>
    <tr>
        ...
        <td width=14%> <?php if ($v->new_pokaz == '') {
                echo "0";
                $v->new_pokaz = 0;
            } else {
                echo sprintf("%.0f", $v->new_pokaz);
            } ?> </td>
        <td width=14%> <?php if ($v->old_pokaz == '') {
                echo sprintf("%.0f", $v->new_pokaz);
            } else {
                echo sprintf("%.0f", $v->old_pokaz);
            } ?> </td>
        <td width=14%> <?php if ($v->counter_diff == '') {
                echo "0";
            } else {
                echo sprintf("%.0f", $v->counter_diff);
            } ?> </td>
        <td width=14%> <?php if ($v->transform == '') {
                echo "0";
            } else {
                echo sprintf("%.0f", $v->transform);
            } ?> </td>
        <td width=14%> <?php echo sprintf("%.0f", $v->itogo_uchtennyy_kvt);
            $itogokvt += $v->itogo_uchtennyy_kvt; ?> </td>
    </tr>
