...
<table border="1px" width="100%" align="center">
    <tr>
        ...
        <td rowspan="2" width="800px" valign="middle">Сведения о наличие отчета о маркетинговых исследованиях,
...
<table width='2100px' border=0px cellspacing=0 cellpadding=0>
    <tr>
        <td width='2100px'>
            <p><font size="7">Приложение: Перечень документации
                    _______________________________________________________________________________________________</font>
            </p>
        </td>
    </tr>
</table>
...
<table width='2100px' border=0px cellspacing=0 cellpadding=0>
    ...
    <tr>
        <td width='2100'>
            ...
            <h5>* Применяется для приемки-передачи выполненных работ (оказанных услуг), за исключением
                строительно-монтажных работ.</h5>
