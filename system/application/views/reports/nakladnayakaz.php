...
<table border="1px" width="100%" align="center">
    ...
    foreach ($s as $s2):
        ...
        <tr align="center">
            ...
            <TD width="600px">За электроэнергию <br/> <?php echo datetostring3($schetfactura_date->date) . " года"; ?>
            </td>
...
<table>
    ...
    <tr>
        ...
        <td> <?php echo "__________________     " . trim($org->director); ?></td>
        <td></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        ...
        <td> <?php echo "__________________     " . trim($org->glav_buh); ?></td>
        <td></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        ...
        <td> <?php echo "__________________     " . "Квачко Н.В."; ?></td>
        <td></td>
    </tr>
    <tr>
        <td></td>
