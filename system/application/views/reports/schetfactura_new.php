...
<FONT size=7>
    <table width=100%>
        <tr align=center>
            <td width=1850px>
                <b><?php echo(strlen(trim($akt_vypolnenyh_rabot)) == 0 ? "Есеп шот фактура / Счет-фактура" : $akt_vypolnenyh_rabot); ?>
                    №</b> <?php
                if (strlen($schet2) == 0) {
                    echo($schetfactura_date->schet_new);
                } else {
                    echo $schet2;
                }
                echo " от ";
        ...
        <tr>
            <td width=2100px>Жеткізушінің БСН мен мекенжайы<br/>БИН и адрес поставщика
                <u>  <?php echo "БИН " . $org->bin . ", " . $org->address . " " . $org->svidetelstvo_nds; ?></u></td>
        </tr>
        <tr>
        ...
        <tr>
            <td width=2100px>Жүк алушы БСН<br/>Грузополучатель БИН
                <u>  <?php echo $firm->bin . ", " . $firm->name . ", " . $firm->address; ?>                                                                                                                 </u>
            </td>
            <td></td>
        </tr>
        <tr align=right>
    ...
    <table border="1px" width="100%" align="center">
        ...
        <?php if ($fine_value > 0): ?>
            <tr>
                <td width="60px" align="center"><?php echo $i++; ?></td>
                <td width="400px" align="center">Пеня</td>
                <td width="100px" align="center">тенге</td>
        ...
        <tr align="center">
            ...
            <td width="160px" bgColor=#c0c0c0></td>
            <td width="200px" align="right"><b><?php echo f_d($sumnds); ?></b></td>
...
<FONT size=7>
    <table width="100%">
        <tr>
            <td align="left"><b>Ұйымның басшысы <br/>Зам. директора по
                    сбыту <?php echo trim($org->nachalnik_otdela_sbyta); ?></b></td>
            <td></td>
            <td align="right"><b>БЕРДІ (жеткізушінің жауапты тұлғасы)<br/>ВЫДАЛ (ответственное лицо поставщика) <br/>Инженер:
                    ______________________________</b></td>
        </tr>
        <tr>
            <td></td>
            <td align="center">
