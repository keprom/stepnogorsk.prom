...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: xx-small;">
    ...
    <?php foreach ($sql_result->result() as $data): ?>
        <?php if ($last_group != $data->subgroup_id): ?>
            <?php if ($last_group != -1): ?>
                <tr class="tr-hover" align=right>
                    ...
                    <td><b><?php echo round((f_d($sum_debet_end)), 2); ?></b></td>
                    <td><b><?php echo round((f_d($sum_kredit_end)), 2); ?></b></td>
        ...
        <tr class="tr-hover">
            ...
            <?php $saldo = (f_d($data->debet_value)) - (f_d($data->kredit_value)) - (f_d($data->oplata_value)) + (f_d($data->nachisleno)); ?>
            <td align=right>
        ...
        $sum_debet += (f_d($data->debet_value));
        $sum_kredit += (f_d($data->kredit_value));
        $sum_nachisleno += (f_d($data->nachisleno));
        $sum_oplata += $data->oplata_value;
        $sum_kredit_end += (f_d(($saldo < 0 ? -1 * $saldo : 0)));
        $sum_debet_end += (f_d(($saldo > 0 ? $saldo : 0)));
    ...
    <tr class="tr-hover" align=right>
        ...
        <td><b><?php echo((f_d3($sum_nachisleno))); ?></b></td>
        <td><b><?php echo f_d($sum_oplata); ?></b></td>
