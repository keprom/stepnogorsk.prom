...
<FONT size=7>
    <table width=100%>
        <tr align=center>
            <td width=1850px>
                <b><?php echo(strlen(trim($akt_vypolnenyh_rabot)) == 0 ? "2Есеп шот фактура / Счет-фактура" : $akt_vypolnenyh_rabot); ?>
                    №</b> <?php
                if (strlen($schet2) == 0) {
    ...
    <table border="1px" width="100%" align="center">
        ...
        foreach ($s as $s2):
            ...
            <tr align="center">
                ...
                <TD width="400px">За электроэнергию <br/> <?php echo datetostring2($schetfactura_date->date); ?> года
                </td>
