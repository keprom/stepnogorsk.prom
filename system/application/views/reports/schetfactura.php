...
<FONT size=7>
    <table width=100%>
        ...
        <tr>
            <td width=2100px><b>Продавец</b> <u><?php echo $org->org_name; ?></u>

            </td>
            <td> (2)</td>
        </tr>
        <tr>
            <td width=2100px> РНН, БИН и адрес местнахождения
                продавца <?php echo " <u>" . $org->rnn . " " . $org->bin . " " . $org->address; ?></u>
            </td>
            <td> (2а)</td>
        </tr>
        <tr>
            <td width=2100px> Расчетный счет продавца <u><?php echo $org->IIK; ?> КБЕ-<?php echo $org->Bank_kbe; ?>
        ...
        <tr>
            <td width=2100px> Грузополучатель
                <u><?php echo $edit6; ?>                                                                                                                     </u>
            </td>
            <td> (9)</td>
        </tr>
...
<FONT size=7>
    <table width="100%" align=left>
        <tr>
            ...
            <td align="right"><b>ВЫДАЛ (ответственное лицо продавца) </b></td>
        </tr>
        <tr>
            <td align="left"></td>
            <td align="right"></td>
