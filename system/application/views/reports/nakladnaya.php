...
<table width=100%>
    ...
    <table border=1 cellspacing=0 cellpadding=0 width=30% align=right>
        ...
        <tr>
            ...
            <td align=center><?php echo $schetfactura_date->schet_new; ?></td>
            <td align=center><?php
            ...
            <table border=1 cellspacing=0 cellpadding=0 width=100%>
                ...
                foreach ($s as $s2):
                    ...
                    <tr>
                        ...
                        <td align=center>Электроэнергия за <?php echo datetostring2($schetfactura_date->date); ?>года
                        </td>
                        <td align=center>
                            <o:p></o:p>
                        </td>
                        ...
                        <td align=center><?php echo f_d($s2->tariff_value); ?></td>
                        <td align=center><?php
    ...
    <tr>
        <td>
            <table border=0 cellspacing=0 width=600px>
                <tr>
                    <td width=250px>Отпуск разрешил </br>Зам. директора по сбыту
                    <td colspan=3><u><?php echo " " . trim($org->nachalnik_otdela_sbyta); ?></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________________
                    </td>
                    </td></tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td colspan=3><u> <?php echo trim($org->glav_buh); ?> </u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________________
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan=2 align=left><sup><i>(Ф.И.О.)</i></sup></td>
                    <td align=left><sup><i> (Подпись)</i></sup></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Отпустил</td>
                    <td colspan=3><u><?php echo "_____________"; ?></u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________________
                    </td>
                </tr>
                <tr>
                    <td></td>
        ...
        <td>
            <table width=600px>
                <tr>
                    <td colspan=3>
                        По доверенности № <?php echo $edit3 . "___  от ____  _______20___года"; ?>
                    </td>
