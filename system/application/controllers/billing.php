...
class Billing extends Controller
{
    ...
    function god_report()
    {
        $data['god'] = $this->db->get('industry.ALPHA');
        $this->load->view('reports/god_report', $data);
    }
...
//                $this->db->insert('industry.oplata', $data);
   ...
   left join industry.billing_point on 
    ...
    function numberofschet()
    {
        $sql = "SELECT * from industry.numberofschet";
        $data['firm'] = $this->db->query($sql);
        $this->load->view("reports/nuberofschet", $data);
    }
...
where firm_id={$this->uri->segment(3)} and data_finish is null";
   	...
   	public function export_rekvizit_schet()
    {
        ...
        if ($db) {
            ...
            if (!copy("c:/oplata/rschet.dbf", "c:/oplata/stpngr{$month}.dbf")) {
    ...
    public function migration()
    {
        ...
        $this->export_to_excel("other_reports/migration", $data,"степногорский_рэс");
